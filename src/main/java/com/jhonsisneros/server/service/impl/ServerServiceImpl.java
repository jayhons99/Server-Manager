package com.jhonsisneros.server.service.impl;
...
import com.jhonsisneros.server.service.ServerService;
...
public class ServerServiceImpl implements ServerService {
    ...
    public Server create(Server server) {
        log.info("Saving new server: {}", server.getNameOfServer());
    ...
    public Server update(Server server) {
        log.info("Updating server: {}", server.getNameOfServer());
        return serverRepository.save(server);
    }
